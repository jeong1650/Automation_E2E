...
public class iAPv21_LGU_E2E_Test extends BaseDriver_iAPv21_LGU {

	/* -----------------------------------------------------------------------------
	 * @ Editor = Jeong Inho
	 * @ TCID = iAPv21_Daily_LGU
	 * -----------------------------------------------------------------------------
	*/
	@Test
	public void iAPv21_Daily_LGU() throws Exception {
		TCID = "iAPv21_Daily_LGU ";
		result = "FAIL";
		...
		driver.swipe(555, 1980, 555, 1980, -1);
