...
public class iAPv21_SKT_E2E_Test extends BaseDriver_iAPv21_SKT {

	/* -----------------------------------------------------------------------------
	 * @ Editor = Jeong Inho
	 * @ TCID = iAPv21_Daily_SKT
	 * -----------------------------------------------------------------------------
	*/
	@Test
	public void iAPv21_Daily_SKT() throws Exception {
		TCID = "iAPv21_Daily_SKT ";
		result = "FAIL";
		...
		driver.swipe(537, 2127, 537, 2127, -1);
