...
public class BaseDriver_iAPv21_KT {
...
protected Dimension size;
	...
	public void end() {
		if (result != "PASS") {
			...
			try {
				String filePath = "C:\\ProgramData\\Jenkins\\.jenkins\\workspace\\iAPv21_KT_E2E\\failSC\\";
		...
		System.out.println("======================================");
		System.out.println("        IAPv21_KTResult : " + result);
